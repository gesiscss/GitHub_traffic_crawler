...
CSV_FOLDER = os.path.dirname(os.getcwd()) + "/GitHub_traffic_crawler/gh_traffic/CSV_Files"
...
def giveFullPandaFiles(type="views"): #return list of tuples with format : (path, concatenated dataframe)
    ...
    if str(type) is not "views" and str(type) is not "referrers" and str(type) is not "clones":
